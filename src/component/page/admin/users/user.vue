            ...
            <ul class="checkbox-list">
                ...
                <rl-permission tag="li" :permissions="'modify_person'">
                    ...
                    <ul class="checkbox-list" v-if="person.limits">
                        <li>
                            <input type="checkbox" id="permission-book-limit" value="user" @change="$set(person.limits, 'books', $event.srcElement.checked ? 7 : null)" :checked.prop="person.limits.books" />
                        ...
                        <li>
                            <input type="checkbox" id="permission-day-limit" value="user" @change="$set(person.limits, 'days', $event.srcElement.checked ? 7 : null)" :checked.prop="person.limits.days" />
